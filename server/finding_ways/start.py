...
from server.finding_ways.full_1 import brute_force_algorithm
from server.finding_ways.full_2 import find_optimal_solution
from server.finding_ways.greedy import calculate_total_distance, greedy_algorithm
