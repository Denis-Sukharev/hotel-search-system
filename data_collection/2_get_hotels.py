...
def add_poi_type_to_db(poi_id, type_name):
    cursor.execute('''INSERT INTO poi_type (poi_id, type) VALUES (%s, %s);''', (poi_id, type_name))
    conn.commit()
...
for link in hotel_links[:50]:
    ...
    if coord:
        ...
        if district:
            ...
            add_poi_type_to_db(poi_id, 'residence')
